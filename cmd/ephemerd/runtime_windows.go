...
// or failed to start).
func startContainerRuntime(dataDir string, log *slog.Logger, linuxVMEnabled bool, _ uint32, _ string, dindEnabled bool, linuxVMCPUs uint, linuxVMMemoryMB uint64) (*client.Client, func() (*scheduler.DispatchClient, *client.Client), func(), error) {
