...
func (p *Proxy) Stop() error {
	...
	// Stop the eviction loop before the listener: a pass in flight holds no
	// lock the shutdown needs, but leaving it running past Stop would let it
	// walk a cache directory that Cleanup below is concurrently removing.
	if p.pruneStop != nil {
